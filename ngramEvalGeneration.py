...
from models.ngram import template_generator
...
class Trainer(object):
    ...
    def prepare_datasets(self, datasets, max_samples=None):
        ...
        def group_texts(examples):
            ...
            examples = {"text": [self.encoder(item)
    ...
    def eval_model(self, key, data_files, model):
        ...
        print("*** Model testing ***")
        print("WARNING: this script is only for generation evaluation,"
                "don't use it for accuracy, MRR, etc. metrics ")
        predictions = template_generator(
            model, test_dataset, self.context_size, method='greedy')
